...
<meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        <div class="row mx-1">
        <p class="p-test mt-1 mb-0 fs-3">新增客戶群組</p>
            <form method="POST" action="{{ route('customer_group.store') }}" enctype="multipart/form-data" class="row">
              {{ csrf_field() }}
            ...
            <div class="row mt-2 align-items-center">    
               ...
               <div class="col-md-4 border-0 d-inline-flex align-items-start">
                  <input class="place w-50 d-inline-flex" name="group" placeholder="{{old('group')}}">
               </div>
